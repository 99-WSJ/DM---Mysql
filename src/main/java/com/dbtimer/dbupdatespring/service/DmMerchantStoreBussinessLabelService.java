...
*/
public interface DmMerchantStoreBussinessLabelService extends IService<DMmerchantStoreBussinessLabelEntity> {
    List<DMmerchantStoreBussinessLabelEntity> getAll();
